...
export const APIS = [AVISService, AnterogradiaService, PublicService, ResourcesService, StatusService, TangentialAuthService, TangentialAuxiliaryService, TangentialContentService, TopicsService];
